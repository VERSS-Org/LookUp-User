...
const Map<String, String> stringsEs = {
  ...
  'home.companies_for_you': 'Empresas que podrían interesarte',
  ...
  'offers.modality': 'Modalidad',
  'offers.save': 'Guardar vacante',
  'offers.saved': 'Vacante guardada',
  'offers.unsave': 'Quitar de guardados',
  ...
  'company.follow': 'Seguir empresa',
  'company.following': 'Siguiendo',
  ...
  'profile.view_all': 'Ver todas las {section}',
  ...
  'banner.title': 'Banner del perfil',
  'banner.pick': 'Seleccionar imagen',
  'banner.too_big': 'La imagen no debe superar 5 MB.',
  'banner.error': 'No se pudo subir el banner.',
...
const Map<String, String> stringsEn = {
  ...
  'home.companies_for_you': 'Companies you may be interested in',
  ...
  'offers.modality': 'Work mode',
  'offers.save': 'Save vacancy',
  'offers.saved': 'Vacancy saved',
  'offers.unsave': 'Remove from saved',
  ...
  'profile.view_all': 'View all {section}',
  ...
  'banner.title': 'Profile banner',
  'banner.pick': 'Choose image',
  'banner.too_big': 'The image must not exceed 5 MB.',
  'banner.error': 'The banner could not be uploaded.',
  ...
  'modalidad.remoto': 'Remote',
  'modalidad.hibrido': 'Hybrid',
  'modalidad.na': 'Not specified',
